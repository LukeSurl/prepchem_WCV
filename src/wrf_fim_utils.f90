...
subroutine write_to_FIM(n2,n3,nspecies,nsrc,var2d,plume_mean_fct &
    ...
    integer, parameter :: nspecies_wrf = 45
...
!-------------------------- volcanoes -------------------------
print*,'=> Volcanoes Eruption Section ----xx--------------------'
...
if(use_volcanoes == 1) then
   ...
   open (91,file=fileBB,form='unformatted')
     ...
     print*,'I think nspecies is =',nspecies
     iv=0
     do ispc_wrf=1,nspecies_wrf
      do ispc = 1,nspecies
        if(trim(spc_name_wrf(ispc_wrf)) == trim(spc_name(ispc))) then
         if(trim(spc_name_wrf(ispc_wrf)) == 'ASH' .or.  &
            trim(spc_name_wrf(ispc_wrf)) == 'H2O' .or.  &
            trim(spc_name_wrf(ispc_wrf)) == 'SO2' .or.  &
            trim(spc_name_wrf(ispc_wrf)) == 'SULF' .or.  &
            trim(spc_name_wrf(ispc_wrf)) == 'BR'  .or.  &
            trim(spc_name_wrf(ispc_wrf)) == 'HBR' .or.  &
            trim(spc_name_wrf(ispc_wrf)) == 'HOBR' .or.  &
            trim(spc_name_wrf(ispc_wrf)) == 'BR2' .or.  &
            trim(spc_name_wrf(ispc_wrf)) == 'BRO' .or.  &
            trim(spc_name_wrf(ispc_wrf)) == 'CL' .or.  &
            trim(spc_name_wrf(ispc_wrf)) == 'HCL' .or.  &
            trim(spc_name_wrf(ispc_wrf)) == 'HOCL' .or.  &
            trim(spc_name_wrf(ispc_wrf)) == 'CL2' .or.  &
            trim(spc_name_wrf(ispc_wrf)) == 'CLO' .or.  &
            trim(spc_name_wrf(ispc_wrf)) == 'HO' .or.  &
            trim(spc_name_wrf(ispc_wrf)) == 'HO2' .or.  &
            trim(spc_name_wrf(ispc_wrf)) == 'NO' .or.  &
            trim(spc_name_wrf(ispc_wrf)) == 'NO2' .or.  &
            trim(spc_name_wrf(ispc_wrf)) == 'HNO3' .or.  &
            trim(spc_name_wrf(ispc_wrf)) == 'HG'  ) then
	 dummy=0.
	 print*,' specie=',trim(spc_name(ispc))
...
!-------------------------- volcanoes -------------------------
print*,'=> ------------------------------------------------------'
print*,'=> Volcanoes Eruption Section ---------WRF---------------'
...
if(use_volcanoes == 1) then
   ...
   open (91,file=fileBB,form='unformatted')
	 ...
	 print*,' specie=',trim(spc_name(ispc))
	   ...
	   if( trim(spc_name_wrf(ispc_wrf)) == 'SO2'.or. &
            trim(spc_name_wrf(ispc_wrf)) == 'H2O' .or. &
            trim(spc_name_wrf(ispc_wrf)) == 'SULF' .or. &
            trim(spc_name_wrf(ispc_wrf)) == 'BR' .or. &
            trim(spc_name_wrf(ispc_wrf)) == 'HBR' .or. &
            !trim(spc_name_wrf(ispc_wrf)) == 'HOBR' .or. & !BODGE
            trim(spc_name_wrf(ispc_wrf)) == 'BR2' .or. &
            trim(spc_name_wrf(ispc_wrf)) == 'BRO' .or. &
            trim(spc_name_wrf(ispc_wrf)) == 'CL' .or. &
            trim(spc_name_wrf(ispc_wrf)) == 'HCL' .or. &
          ...
          elseif(trim(spc_name_wrf(ispc_wrf)) == 'HOBR') then !bodge fix weird error
            dummy(i,j) = 0.
         ...
         enddo;enddo
         print*, 'assigning to dummy gas species=',trim(spc_name(ispc))
	 write(91) dummy
